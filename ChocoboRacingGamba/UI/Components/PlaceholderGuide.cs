...
internal static class PlaceholderGuide
{
    private static readonly (string Token, string Inserts)[] ClassicTokens =
    {
        ...
        ("{betplayer}",      "The player whose bet it is. Bet Confirmed and Bet Removed messages only."),
        ("{betchocobo}",     "The chocobo that bet was placed on. Bet Confirmed and Bet Removed messages only."),
        ("{betamount}",      "How much gil that bet was for. Bet Confirmed and Bet Removed messages only."),
